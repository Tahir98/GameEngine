...
ShapeRenderer2D::ShapeRenderer2D(): program("Shaders/shaperenderer2d.shader") {
	va = new VertexArray();
...
inline void ShapeRenderer2D::addColor(Color c1){
	vertices.push_back(c1.r);
	vertices.push_back(c1.g);
	vertices.push_back(c1.b);
	vertices.push_back(c1.a);
}
